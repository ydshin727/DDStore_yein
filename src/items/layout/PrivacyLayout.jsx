      ...
      <div className="policy-page">
        <div className="policy-container">
          ...
          <div className="policy-box">
            ...
            <p>
              (주)댕댕상점 은 (이하 "회사"는) 고객님의 개인정보를 중요시하며, "개인정보 보호법" 등 관련 법령을 준수하고 있습니다. <br />
            ...
            <p>
              ...
              o 위탁 대상자 : [택배사 이름] CJ대한통운 <br />
            </p>
            <p>
              o 위탁 대상자 : [PG사 이름] 케이에스넷 <br />
            </p>
            <p>
            ...
            <p>
              ...
              성명 : 김댕댕 <br />
              소속 :기획부 <br />
              전화번호 : 02-6953-2002 <br />
              이메일 : dangdang@store.com <br />
            </p>
            <p>
